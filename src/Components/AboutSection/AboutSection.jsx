...
const AboutSection = () => {
 ...
 className="text-4xl md:text-5xl font-bold text-blue-800 mb-4">About LifeCare Hospital</h2>
 ...
 className="text-lg text-gray-700 mb-6">
          ...
          <ul className="space-y-3 mb-8">
            <li             data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out"
